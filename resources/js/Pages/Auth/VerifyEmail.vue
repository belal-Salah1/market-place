...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            <div class="flex flex-col items-center gap-4 animate-fade-in-up delay-3">
                <PrimaryButton
                ...
                <Link
                    ...
                    method="post"
                    as="button"
                    class="text-sm font-medium text-gray-500 transition-colors duration-200 hover:text-indigo-600"
                >
                    Sign out
                </Link>
            </div>
