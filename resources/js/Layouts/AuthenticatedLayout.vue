    ...
    <div>
        <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-50 to-violet-100 dark:from-gray-950 dark:via-slate-900 dark:to-gray-950">
            ...
            <div class="pointer-events-none absolute inset-0 overflow-hidden">
                <div data-gsap-float="slow" class="absolute -top-20 -right-20 h-72 w-72 rounded-full bg-indigo-200/30 dark:bg-indigo-800/20 blur-3xl" />
                <div data-gsap-float class="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-violet-200/25 dark:bg-violet-800/15 blur-3xl" />
                <div data-gsap-float="slow" class="absolute top-1/2 right-1/4 h-48 w-48 rounded-full bg-purple-200/20 dark:bg-purple-800/15 blur-3xl" />
            </div>

            <!-- Navigation -->
            <nav data-gsap="fade-down" class="relative z-50 border-b border-white/60 bg-white/70 dark:border-white/10 dark:bg-gray-900/80 backdrop-blur-2xl">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center gap-8">
                            <Link :href="route('dashboard')" class="flex shrink-0 items-center text-indigo-600 dark:text-indigo-400 transition-transform duration-300 hover:scale-105">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:gap-3">
                            <button @click="toggleDark" class="flex h-8 w-8 items-center justify-center rounded-full border border-white/80 bg-white/60 text-gray-500 transition-all duration-300 hover:bg-white hover:text-gray-700 dark:border-white/10 dark:bg-white/5 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-yellow-400" title="Toggle dark mode">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        >
                                            ...
                                            <svg class="h-4 w-4 text-gray-400 dark:text-gray-500 transition-transform duration-300 group-hover:rotate-180" viewBox="0 0 20 20" fill="currentColor">
                ...
                >
                    <div v-show="showingNavigationDropdown" class="sm:hidden">
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 px-3 pb-3 pt-4">
            ...
            <!-- Header -->
            <header v-if="$slots.header" data-gsap="fade-in" data-gsap-delay="0.1" class="relative z-10 border-b border-white/40 bg-white/50 dark:border-white/10 dark:bg-gray-900/50 backdrop-blur-sm">
            ...
            >
                <div v-if="showFlash && ($page.props.flash?.success || $page.props.flash?.error)" class="relative z-20 mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        class="flex items-center gap-3 rounded-xl border border-emerald-200/60 bg-emerald-50/80 dark:border-emerald-700/60 dark:bg-emerald-950/80 px-4 py-3 shadow-sm backdrop-blur-sm"
                    >
                    ...
                    <div
                        ...
                        class="flex items-center gap-3 rounded-xl border border-red-200/60 bg-red-50/80 dark:border-red-700/60 dark:bg-red-950/80 px-4 py-3 shadow-sm backdrop-blur-sm"
                    >
